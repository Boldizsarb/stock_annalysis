...
from correlation import calculate_nvda_correlation
...
def sell_prediction_forecast2(days_to_forecast): ## the parameter is the what is the time interval, how long into the future!
    ...
    top_correlated, least_correlated = calculate_nvda_correlation()
